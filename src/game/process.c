...
Process* HuPrcChildCreate(void (*func)(void), u16 prio, u32 stack_size, s32 extra_data_size, Process* parent) {
    Process* child = HuPrcCreate(func, prio, stack_size, extra_data_size);
